...
const pillars = [
  {
    ...
    description:
      "We deliver a rigorous, concept-driven curriculum that encourages deep understanding, critical thinking, & intellectual curiosity. Our approach inspires students to move beyond memorisation, developing analytical abilities & a genuine passion for lifelong learning.",
    icon: BookOpen,
  ...
  },
  {
    ...
    description:
      "We cultivate awareness and appreciation of diverse cultures, perspectives, and global challenges. Through this understanding, students grow into respectful, compassionate, and responsible citizens who contribute thoughtfully to the wider world.",
    icon: Globe2,
    accent: "from-sky-500/80 to-cyan-500/40",
  },
  {
    title: "Innovation & Inquiry",
    description:
      "We deliver a rigorous, concept-driven curriculum that encourages deep understanding, critical thinking & intellectual curiosity. Our approach inspires students to move beyond memorisation, developing analytical abilities & a genuine passion for learning.",
    icon: Lightbulb,
    accent: "from-amber-500/80 to-yellow-500/40",
  },
  {
    title: "Values & Character",
    description:
      "Integrity, empathy, respect, and resilience form the foundation of our community. These values are woven into everyday school life through meaningful interactions, service initiatives, and reflective practices that shape responsible and ethical individuals.",
    icon: HeartHandshake,
    accent: "from-rose-500/80 to-pink-500/40",
  },
  {
    title: "Holistic Development",
    description:
      "Education at MCS extends far beyond the classroom. By balancing academic pursuits with sports, arts, leadership opportunities, and wellness programmes, we support the physical, emotional, and creative development of every learner.",
    icon: Users,
    accent: "from-emerald-500/80 to-lime-500/40",
  },
  {
    title: "Personalised Guidance",
    description:
      "We recognise the individuality of each student. Through mentorship, constructive feedback, and differentiated support, we ensure that every learner feels valued, understood, and guided on their unique educational journey.",
    icon: Star,
    accent: "from-blue-500/80 to-indigo-500/40",
  },
];

const VisionMission: React.FC = () => {
  return (
    <main className="pt-4 sm:pt-10 mt-10 bg-white">
      {/* VISION + MISSION */}
      <section
        id="vision-mission"
        className="relative"
      ...
      {/* CORE PHILOSOPHY */}
      <section className="my-10 py-12 md:py-20 bg-linear-to-r from-blue-950 via-blue-900 to-blue-950">
          ...
          <div className="relative">
            <div className="flex flex-col md:flex-row items-center gap-30">
              ...
              <div className="md:w-2/3 text-white">
                <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-4 py-2 text-sm font-poppins mb-6">
                  Our Core Philosophy
                </div>

                <blockquote className="text-2xl min-[540px]:text-3xl font-playpen font-medium leading-tight text-yellow-400">
                ...
                <p className="mt-8 text-lg text-gray-300 leading-relaxed">
                  At Montessori Cambridge School, our philosophy of education draws deep inspiration from the timeless teachings of Swami Vivekananda, whose words continue to motivate generations toward purposeful action and self-realisation
                </p>

                <p className="mt-6 text-lg text-gray-300 leading-relaxed">
                  Guided by this enduring principle, we strive to cultivate in our students a spirit of perseverance, self-belief, and purposeful ambition. Education at MCS is designed not only to impart knowledge, but also to awaken the inner strength and character that enable young minds to face challenges with courage and conviction.
                </p>

                <p className="mt-6 text-lg text-gray-300 leading-relaxed">
                  By nurturing confidence, resilience, and clarity of thought, we encourage every learner to develop the determination required to overcome obstacles, think independently, and solve problems with wisdom and creativity. In doing so, MCS seeks to empower each student to realise their fullest potential—growing into individuals who pursue excellence with dedication and contribute meaningfully to the world around them.
                </p>
      ...
      {/* PILLARS */}
      <section className="py-4 sm:py-10 my-20">
        <div className="mx-auto max-w-7xl px-6 min-[540px]:px-12 sm:px-16 lg:px-20 xl:px-0">
          <div className="text-center mb-16">
            <h2 className="text-2xl min-[540px]:text-3xl text-gray-900 font-playpen font-medium leading-normal">
              Pillars defining the{" "}
              <br className="hidden"></br>
              <span className="relative inline-block">
                MCS Experience
                {/* Spark Doodle */}
            ...
            <p className="mt-2 text-base sm:text-lg text-gray-700 max-w-3xl mx-auto">
              Every initiative, interaction, and learning experience at MCS is guided by principles that shape responsible, confident, and future-ready individuals.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            {pillars.map((pillar, index) => {
              ...
              return (
                <div
                  key={index}
                  className="relative overflow-hidden rounded-4xl bg-white shadow-lg transition-all duration-300 hover:shadow-2xl hover:scale-[1.02]"
                >
                  <div className="relative z-10 p-8 lg:p-10">
                    <div
                      className={`flex h-16 w-16 items-center justify-center rounded-2xl bg-linear-to-br ${pillar.accent} text-white shadow-lg`}
                    >
                      <Icon className="h-8 w-8" />
                    </div>

                    <h3 className="mt-8 text-xl sm:text-2xl font-poppins font-semibold text-gray-900 leading-tight">
                      {pillar.title}
                    </h3>
