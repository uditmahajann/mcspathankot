...
const ParentPartnership: React.FC = () => {
  return (  
    <section className="relative py-15 sm:py-25 pb-20 md:pb-40 lg:pb-50 xl:pb-60 bg-orange-100 overflow-hidden">
      <img
        src="/Images/Academics/middlefooter.png"
      ...
      <div className="mx-auto max-w-7xl px-6 min-[540px]:px-12">
        ...
        <div className="text-center max-w-4xl mx-auto mb-8 sm:mb-12">
          ...
          <p className="mt-4 sm:mt-6 text-base sm:text-lg text-gray-700 max-w-4xl mx-auto leading-normal">
            We believe a child’s achievements flourish when school and family work together. Our communication channels ensure parents remain informed, connected, and empowered throughout their middle-school journey.
          </p>
        </div>
