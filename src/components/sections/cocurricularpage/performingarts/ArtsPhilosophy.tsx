        ...
        <div className="mx-auto max-w-7xl px-6 min-[540px]:px-12">
          <div className="max-w-5xl mb-20">
            <h2 className="text-5xl sm:text-6xl lg:text-7xl font-poppins font-semibold leading-tight">
              Inspiring Spaces for Creative Expression
            </h2>

            <p className="mt-8 text-lg text-gray-400 leading-relaxed max-w-3xl">
              Thoughtfully designed environments that encourage artistic exploration, performance, confidence, collaboration, and the holistic development of every young performer.
            </p>
          </div>
...
//               <div
//                 key={index}
//                 className="group relative overflow-hidden rounded-[2rem] aspect-[16/10]"
//               >
//                 <img
//                   src={item.image}
//                   alt={item.title}
