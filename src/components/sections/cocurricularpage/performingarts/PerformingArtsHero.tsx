        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 min-[540px]:px-12 py-25 w-full">
          <div className="max-w-5xl">
            ...
            <p className="mt-8 text-lg sm:text-xl text-gray-300 max-w-2xl leading-relaxed">
              Where confidence, creativity, expression, and imagination come
              alive through movement, music, storytelling, and performance.
            </p>
          </div>
        </div>
      </section>
...
// const gallery = [
//   "/Images/Arts/art1.jpg",
//   "/Images/Arts/art2.jpg",
//   "/Videos/gallery1.mp4",
//   "/Images/Arts/art3.jpg",
//   "/Videos/gallery2.mp4",
...
//         <div className="absolute top-0 left-0 h-[500px] w-[500px] rounded-full bg-fuchsia-500/20 blur-3xl" />
//         <div className="absolute bottom-0 right-0 h-[500px] w-[500px] rounded-full bg-orange-500/20 blur-3xl" />

//         <div className="relative z-10 mx-auto max-w-7xl px-6 min-[540px]:px-12 py-32 w-full">
//           <div className="max-w-5xl">
//             <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 backdrop-blur-xl px-5 py-2 text-sm text-white mb-8">
//               <Sparkles className="h-4 w-4" />
//               Creativity & Expression at MCS
//             </div>

//             <h1 className="text-6xl sm:text-7xl lg:text-[9rem] font-poppins font-semibold leading-[0.9] tracking-tight">
//               PERFORMING
//               <br />
//               ARTS
//             </h1>
...
//               <a
//                 href="#showcase"
//                 className="inline-flex items-center gap-2 rounded-full bg-white px-7 py-4 text-black font-medium hover:scale-[1.03] transition"
//               >
...
//           <p className="text-2xl sm:text-4xl lg:text-6xl font-playpen text-white leading-relaxed">
//             It begins with a rehearsal.
//           </p>

//           <p className="mt-24 text-xl sm:text-3xl lg:text-5xl text-gray-400 leading-relaxed">
//             A nervous breath backstage.
//             <br />
//             A final practice.
//             <br />
//             The lights dim.
...
//           <p className="mt-24 text-4xl sm:text-6xl lg:text-8xl font-poppins font-semibold text-yellow-300 leading-[0.95]">
//             Then confidence takes the stage.
//           </p>
//         </div>
//       </section>
...
//                 <p className="text-sm tracking-[0.35em] text-fuchsia-400 uppercase">
//                   Performing Arts
//                 </p>
...
//                 <div
//                   key={index}
//                   className="break-inside-avoid overflow-hidden rounded-[2rem] bg-neutral-900"
//                 >
//                   {isVideo ? (
//                     <video
//                       src={item}
...
//           <p className="mt-12 text-2xl sm:text-4xl font-playpen text-yellow-300 leading-relaxed">
//             Every performance becomes
//             <br />
...
//             <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 backdrop-blur-xl px-5 py-2 text-sm text-white mb-8">
//               <Sparkles className="h-4 w-4" />
//               The Creative Spirit of MCS
//             </div>

//             <h1 className="text-5xl sm:text-6xl lg:text-8xl font-poppins font-semibold leading-[0.92] tracking-tight text-white">
//               Where Every Child Finds Their Voice
//             </h1>

//             <p className="mt-8 max-w-3xl text-lg sm:text-xl text-gray-300 leading-relaxed">
//               Performing arts at MCS are not simply activities. They are transformative experiences that nurture confidence, creativity, collaboration, discipline, and self-expression.
//             </p>
...
//         <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
//           <p className="text-2xl sm:text-3xl lg:text-5xl font-playpen leading-relaxed text-white">
//             It begins quietly.
//           </p>

//           <p className="mt-20 text-xl sm:text-2xl lg:text-4xl text-gray-300 leading-relaxed">
//             A nervous breath backstage.
//             <br />
//             A final rehearsal.
//             <br />
...
//           <p className="mt-24 text-3xl sm:text-5xl lg:text-7xl font-poppins font-semibold leading-tight text-yellow-300">
//             Then the lights dim.
//           </p>
...
//           <p className="mt-24 text-3xl sm:text-5xl lg:text-7xl font-poppins font-semibold leading-tight text-white">
//             And suddenly...
//             <br />
//             the stage becomes a place of transformation.
//           </p>
//         </div>
//       </section>
